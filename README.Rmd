...
<!-- badges: start -->
[![Travis build status](https://travis-ci.org/HarmonicAnova21/OPER782.WI2020.svg?branch=master)](https://travis-ci.org/HarmonicAnova21/OPER782.WI2020)
<!-- badges: end -->
...
git_url <- c('https://github.com/chale/reponame',
             'https://github.com/ciaravina/reponame',
             'https://github.com/hufstetler/reponame',
             'https://github.com/leiby/reponame',
             'https://github.com/mayo/reponame',
             'https://github.com/spangler/reponame',
             'https://github.com/walton/reponame',
             'https://github.com/williams/reponame')
```
