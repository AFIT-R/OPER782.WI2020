...
<!-- badges: start -->
[![Travis build status](https://travis-ci.org/AFIT-R/OPER782.WI2020.svg?branch=master)](https://travis-ci.org/AFIT-R/OPER782.WI2020)
<!-- badges: end -->
...
git_url <- c('https://github.com/marcchale/Rexis',
             "https://github.com/bjhufstetler/LeapFrog",
             'https://github.com/mrkaliv/logreg',
             'https://github.com/HarmonicAnova21/Frame.BuildR',
             'https://github.com/ryanwalton57/allyR',
             'https://github.com/clarencew0083/recSystem',
             "https://github.com/clawilso15/Text.Replace")
```
...
knitr::kable(review_table,
             caption = 'List of developers, projects, and assigned reviewers for OPER782 (Winter 2020)')
```
